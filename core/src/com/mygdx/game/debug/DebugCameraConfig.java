...
public class DebugCameraConfig {
    ...
    // defaults
    private static final int DEFAULT_LEFT_KEY = Input.Keys.V;
    private static final int DEFAULT_RIGHT_KEY = Input.Keys.B;
    private static final int DEFAULT_UP_KEY = Input.Keys.N;
    private static final int DEFAULT_DOWN_KEY = Input.Keys.M;
